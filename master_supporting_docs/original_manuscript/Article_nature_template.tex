...
\title[Article Title]{Chronic Intestinal Failure in Brazil: A First Estimative of Prevalence}

\author[1]{\fnm{Carolina } \sur{Melo}}\email{carolinapgm1@insper.edu.br}

\author[2]{\fnm{Maria Paula} \sur{Coelho}}\email{mariapaula.coelho@sabara.com.br}


\author[3]{\fnm{Rogério Carballo} \sur{Afonso}}\email{rogerio.carballo@sabara.com.br}

\author[4]{\fnm{Ivan} \sur{Prenhaca}}\email{igprenhaca@gmail.com}

\author[5]{\fnm{Monica} \sur{Magalhães}}\email{monica.magalhaes@pensi.org.br}

\author[6]{\fnm{Pedro} \sur{Soares}}\email{pedrols5@al.insper.edu.br}
 
\author[7]{\fnm{Vanessa} \sur{Boarati}}\email{vanessa.boarati@pensi.org.br}


\affil[1]{\orgname{Insper Institute of Education and Research}, \orgaddress{Quatá Street, 300}, \city{São Paulo}, \postcode{04546-042}, \state{SP}, \country{Brazil}}

\affil[2]{\orgname{Sabará Children's Hospital}, \orgaddress{\street{Angélica Avenue, 1987}, \city{São Paulo}, \postcode{01227-200}, \state{SP}, \country{Brazil}}}

\affil[3]{\orgname{Sabará Children's Hospital}, \orgaddress{\street{Angélica Avenue, 1987}, \city{São Paulo}, \postcode{01227-200}, \state{SP}, \country{Brazil}}}

\affil[4]{\orgname{Insper Institute of Education and Research}, \orgaddress{Quatá Street, 300}, \city{São Paulo}, \postcode{04546-042}, \state{SP}, \country{Brazil}}

\affil[5]{\orgname{Pensi Institute}, \orgaddress{\street{Angélica Avenue, 2016, 7º andar}, \city{São Paulo}, \postcode{01227-200}, \state{SP}, \country{Brazil}}}

\affil[6]{\orgname{Insper Institute of Education and Research}, \orgaddress{Quatá Street, 300}, \city{São Paulo}, \postcode{04546-042}, \state{SP}, \country{Brazil}}

\affil[7]{\orgname{Pensi Institute}, \orgaddress{\street{Angélica Avenue, 2016, 7º andar}, \city{São Paulo}, \postcode{01227-200}, \state{SP}, \country{Brazil}}}
...
\abstract{
\textbf{Background} Brazil lacks nationwide epidemiological data on the prevalence of Chronic Intestinal Failure (CIF) among pediatric population, a condition that depends on prolonged parenteral nutrition (PN) support. This study aimed to produce the first national prevalence estimate of pediatric CIF in Brazil and to characterize the demographic, clinical, and geographic profile of affected patients.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_tend.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_idade.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_sexo.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_raca_cor.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_total_internacoes.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_duracao_internacoes.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_total_diarias.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_obito.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_alta_melhorada.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\textwidth]{Presentations/images/nutri_paren_id_mapa.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_dist.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Presentations/images/nutri_paren_id_desloc.png}
